      ...
      <div className="w-full max-w-[1400px] mx-auto grid md:grid-cols-2 gap-8 md:gap-12 items-center">
        ...
        >
          ...
          >
            ...
            {/* Tertiary CTA: Download CV - For recruiters and hiring managers */}
            <motion.a
              href="/Artem_Antonenko_Executive_CV.pdf"
              download
              whileHover={{ scale: 1.05 }}
              whileTap={{ scale: 0.95 }}
              className="px-8 py-4 border-2 border-blue-600 text-blue-600 dark:text-blue-400 rounded-full font-semibold hover:bg-blue-50 dark:hover:bg-gray-800 transition-colors inline-flex items-center gap-2"
            >
